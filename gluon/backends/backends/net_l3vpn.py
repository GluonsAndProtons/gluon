...
CONF = cfg.CONF
opt_group = cfg.OptGroup(name='net_l3vpn',
                         title='Options for the net-l3vpn service')
...
class Driver(base.Driver):
    ...
    def __init__(self, backend, logger):
        ...
        self._port_url = backend["url"] + "/v1/" + cfg.CONF.net_l3vpn.ports_name
    ...
    def bind(self, port_id, device_owner, zone, device_id, host_id, binding_profile):
        ...
        return self._client.do_put(url, args)
    ...
    def _convert_port_data(self, port_data):
        ...
        ret_port_data["network_id"] = port_data["id"]
        ...
        ret_port_data["fixed_ips"] = {"ip_address": port_data["ipaddress"], "subnet_id": port_data["id"]}
        ...
        ret_port_data["binding:vnic_type"] = port_data.get("vnic_type", '')
